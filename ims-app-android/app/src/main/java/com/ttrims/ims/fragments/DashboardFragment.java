...
import com.ttrims.ims.ConsoleMainActivity;
import com.ttrims.ims.R;
import com.ttrims.ims.adapters.ProductAdapter;
import com.ttrims.ims.adapters.TransactionAdapter;
import com.ttrims.ims.api.ApiClient;
import com.ttrims.ims.api.ApiService;
import com.ttrims.ims.databinding.FragmentDashboardBinding;
...
public class DashboardFragment extends Fragment {
    ...
    private void setupHubClickListeners() {
        ...
        binding.btnHubLogout.setOnClickListener(v -> {
            if (getActivity() instanceof ConsoleMainActivity) {
                ...
                binding.btnHubLogout.post(() -> {
                    ...
                    getActivity().startActivity(new android.content.Intent(getActivity(), com.ttrims.ims.LoginActivity.class));
                    getActivity().finish();
                });
            }
        });
    ...
    private void navigateToTab(int id) {
        if (getActivity() instanceof ConsoleMainActivity) {
            ((ConsoleMainActivity) getActivity()).selectNavigationItem(id);
        }
    }
