...
import com.ttrims.driver.services.LocationService;
...
import com.ttrims.driver.databinding.FragmentAttendanceBinding;
...
public class AttendanceFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getActivity() instanceof MainActivity) {
            ((MainActivity) getActivity()).setTopBarSubtitle("Attendance");
        }
    }
    ...
    private void startGpsPings() {
        ...
        com.ttrims.driver.utils.SessionManager sm = com.ttrims.driver.utils.SessionManager.getInstance(requireContext());
