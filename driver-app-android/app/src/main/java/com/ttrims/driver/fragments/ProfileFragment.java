...
import com.ttrims.driver.LoginActivity;
...
import com.ttrims.driver.databinding.FragmentProfileBinding;
...
public class ProfileFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getActivity() instanceof MainActivity) {
            ((MainActivity) getActivity()).setTopBarSubtitle("Profile");
        }
    }
        ...
        api.me().enqueue(new Callback<ApiResponse<User>>() {
            ...
            public void onResponse(Call<ApiResponse<User>> call,
                ...
                if (response.isSuccessful() && response.body() != null && response.body().data != null) {
                    ...
                    if (getActivity() instanceof MainActivity) {
                        ((MainActivity) getActivity()).updateAvatar(user.initials());
                    }
                }
            }
