...
import com.ttrims.driver.models.ShipmentStop;
...
public class ShipmentAdapter extends RecyclerView.Adapter<ShipmentAdapter.ViewHolder> {
    ...
    private void openPodScreen(Shipment shipment, ShipmentStop stop) {
        ...
        if (context instanceof androidx.fragment.app.FragmentActivity) {
            ...
            com.ttrims.driver.fragments.PodConfirmFragment podFragment =
                    com.ttrims.driver.fragments.PodConfirmFragment.newInstance(
                            shipment.id, stop.stopId, stop.orderNumber, onStopConfirmed);

            activity.getSupportFragmentManager().beginTransaction()
                    .setCustomAnimations(android.R.anim.slide_in_left, android.R.anim.slide_out_right)
                    .add(com.ttrims.driver.R.id.fragment_container, podFragment, "pod")
                    .addToBackStack("pod")
                    .commit();
        }
    }
