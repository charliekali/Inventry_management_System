...
export const getApiBase = () => {
  ...
  if (Capacitor.isNativePlatform()) {
    return 'https://ttrims-backend-4xho-4xho.onrender.com/api';
  }
...
export const productionPlansAPI = {
  ...
  recordActual: (id, actualQuantity, actualDamage, ingredientWastages) => api.post(`/production-plans/${id}/actual`, { 
    actual_quantity: actualQuantity,
    actual_damage: actualDamage,
    ingredient_wastages: ingredientWastages
  }),
};
