...
const NAV_ITEMS = [
  ...
  { group: 'CRM & Collections', items: [
    { path: '/crm', label: 'CRM Workspace', icon: PhoneCall, perm: 'ORDERS:VIEW' },
    { path: '/crm/leads', label: 'New Leads', icon: Target, perm: 'ORDERS:VIEW' },
    { path: '/crm/customers', label: 'Customers', icon: Users, perm: 'ORDERS:VIEW' },
    { path: '/billing', label: 'Invoice & Billing', icon: ClipboardList, perm: 'ORDERS:VIEW' },
  ]},
  { group: 'Inventory', items: [
    ...
    { path: '/production-run', label: 'Production Run', icon: Factory, perm: 'TRANSACTIONS:STOCK_OUT' },
    { path: '/production-history', label: 'Production History', icon: History, perm: 'TRANSACTIONS:VIEW' },
